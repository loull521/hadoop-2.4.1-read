...
public class WritableRpcEngine implements RpcEngine {
  ...
  private static class Invocation implements Writable, Configurable {
    ...
    public Invocation(Method method, Object[] parameters) {
      ...
      LOG.info("loull - methodName:" + methodName);
      LOG.info("loull - parameterClasses:" + parameterClasses);
      if (parameters != null) {
	      for (Object o : parameters) {
	    	  LOG.info("loull - parameter:" + o);
	      }
      }
    }
    ...
    public String toString() {
      ...
      buffer.append("(");
      //以下似乎有个bug，如果rpc调用没有参数，这个parameter是null
//      for (int i = 0; i < parameters.length; i++) {
//        if (i != 0)
//          buffer.append(", ");
...
//      }
      ...
      } else LOG.info("loull - paramaters is null");
      ////////////////////////////////////
      buffer.append(")");
  ...
  private static class Invoker implements RpcInvocationHandler {
    ...
    public Invoker(Class<?> protocol,
      ...
      this.remoteId = Client.ConnectionId.getConnectionId(address, protocol,
          ticket, rpcTimeout, conf);//获取remoteId
      LOG.info("loull - remoteId: " + remoteId);
    ...
    public Object invoke(Object proxy, Method method, Object[] args)
      ...
      LOG.info("loull - Invocation:" + new Invocation(method, args));
      if (LOG.isDebugEnabled()) {
        long callTime = Time.now() - startTime;
        LOG.debug("Call: " + method.getName() + " " + callTime);
      }
      LOG.info("loull - value: " + value);
      LOG.info("loull - value.get(): " + value.get());
      return value.get();
    }
   ...
   * talking to a server at the named address. <br>
   * 动态代理模式生成proxy
   * @param <T>*/
  @Override
  ...
  public <T> ProtocolProxy<T> getProxy(Class<T> protocol, long clientVersion,
    ...
    T proxy = (T) Proxy.newProxyInstance(protocol.getClassLoader(),
        new Class[] { protocol }, new Invoker(protocol, addr, ticket, conf,
            factory, rpcTimeout));//生成代理对象
    LOG.info("loull - ticket : " + ticket);
  ...
  public static class Server extends RPC.Server {
     ...
     *     can be null for compatibility with old usage (see below for details)<br>
     *     协议接口的class，为了兼容可以为空，如果为空，从protocolImpl中推测出protocolClass
    ...
    static class WritableRpcInvoker implements RpcInvoker {
     ...
     @Override
      public Writable call(org.apache.hadoop.ipc.RPC.Server server,
        ...
        Invocation call = (Invocation)rpcRequest;//rpcRequest就是一个Invocation
