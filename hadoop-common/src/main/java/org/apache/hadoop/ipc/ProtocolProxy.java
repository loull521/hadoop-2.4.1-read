 ...
 * containing a list of its supported methods.<br>
 * 作为一个Protocol proxy的完整信息，包装了协议protocol，protocol的代理proxy，和supportServerMethodCheck<br>
 * 是RpcEngine具体实现类的getProxy返回结果
 * 
