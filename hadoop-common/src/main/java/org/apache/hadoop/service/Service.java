 ...
 * yarn中所有对象，如果非组合服务，直接继承AbstractService，否则继承CompositeService<br>
 * RM，NM都是组合服务
 */
@Public
@Evolving
public interface Service extends Closeable {
   ...
   * {@link STATE#STOPPED}.<br>
   * 状态从 {@link STATE#NOTINITED} to {@link STATE#INITED}，如果操作失败，调用stop()方法，并且进入{@link STATE#STOPPED}状态
   ...
   * fields.<br>
   * 不论什么状态下都能完成这个动作，如果已经在STOPPED状态，则是一个空操作
   ...
   * that are stopping the service from being <i>live</i>.<br>
   * 
