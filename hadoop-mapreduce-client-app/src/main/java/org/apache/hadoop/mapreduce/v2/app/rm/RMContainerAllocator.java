  ...
  */
  ...
  protected synchronized void heartbeat() throws Exception {
    ...
    if (allocatedContainers.size() > 0) {
      scheduledRequests.assign(allocatedContainers);//分配container，并发送TaskAttemptEventType.TA_ASSIGNED事件
    }
  ...
  private class ScheduledRequests {
    ...
    // 分配container，并发送TaskAttemptEventType.TA_ASSIGNED事件
    ...
    private void assign(List<Container> allocatedContainers) {
      ...
      assignContainers(allocatedContainers);//分配containers，发送TaskAttemptEventType.TA_ASSIGNED
    ...
    //发送TaskAttemptEventType.TA_ASSIGNED事件
    @SuppressWarnings("unchecked")
    ...
    private void assignContainers(List<Container> allocatedContainers) {
      ...
      while (it.hasNext()) {
        ...
        if (assigned != null) {
          containerAssigned(allocated, assigned);//发送TaskAttemptEventType.TA_ASSIGNED事件
          it.remove();
        }
      }
