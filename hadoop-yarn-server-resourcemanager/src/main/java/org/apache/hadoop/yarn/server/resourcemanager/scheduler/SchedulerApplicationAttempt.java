 ...
 * of this class.<br>
 * 以Scheduler的角度 表示 appAttempt。一个rmAppAttempt对应一个这个实例。<br>
 * 包括appSchedulingInfo所有分配信息，liveContainers，reservedContainers，currentConsumption,newlyAllocatedContainers
 */
@Private
@Unstable
